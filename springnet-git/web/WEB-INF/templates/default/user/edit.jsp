...
<div id="pagelet_editcomplaint" class="g-pl">
	<div id="editcomplaint-box" class="box wrap">
		...
		<form id="editcomplaint-form" class="g-f" method="post" action="/complaint/editSave">
			<div id="complaint-edit" class="box">
				<p><br /></p>
				<table class="grid">
					<tr>
						<td class="label">Complaint ID:</td>
						<td class="t"><span>${complaint.id}</span></td>
					</tr>
					<tr>
						<td class="label">Employee:</td>
						<td class="t"><span>${complaint.user.firstName} ${complaint.user.lastName}</span><span> (${complaint.user.username})</span></td>
					</tr>
					<tr>
						<td class="label">Report on the equipment:</td>
						<td class="t"><span>${complaint.equipment.name}</span></td>
					</tr>
					<tr>
						<td class="label">Title:</td>
						<td class="t"><span>${complaint.title}</span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="t"><span>${complaint.createDate}</span></td>
					</tr>
				</table>
				<div class="buttons"><div id="btnEdit" class="g-b g-b-r">Save information</div></div>
			</div>
		</form>
	</div>
</div>
